...
#   - coscli installed
#   - CLI tools compiled (make compile-tools for each platform)
...
case "$TARGET" in
  aarch64-apple-darwin) PLATFORM_KEY="darwin-aarch64"; EXT="" ;;
  x86_64-apple-darwin)  PLATFORM_KEY="darwin-x86_64";  EXT="" ;;
  x86_64-pc-windows-msvc) PLATFORM_KEY="windows-x86_64"; EXT=".exe" ;;
...
for TOOL in "${TOOLS[@]}"; do
  ...
  COS_KEY="tools/v${VERSION}/${TOOL}-${PLATFORM_KEY}${EXT}"
