...
const RenderVisualParams = Type.Object({
  ...
  html: Type.String({ description: "Complete HTML content including inline CSS and JS. For chart type: include Chart.js CDN and canvas setup. For diagram type: include Mermaid CDN and div setup. Must be a self-contained HTML document." }),
});
