#!/usr/bin/env python3
"""
Step 5: Polish — wall corners, more decoration, fill empty areas.
Based on step4 (8/10). Target: 9+/10.

Usage:
    /Applications/Blender.app/Contents/MacOS/Blender --background --factory-startup \
        --python scripts/blender/test-step5-polish.py
"""
import bpy
import os
import math
...
# Extra: desk plants, coat rack, trash can, rugs
...
imp("coatRackStanding.glb", pos=(fx-5, fy-4.5, 0), name="forge_coat")
imp("trashcan.glb", pos=(fx+1, fy-4, 0), name="forge_trash")
...
# Extra: table lamp, speaker, rug, coat rack
imp("lampRoundTable.glb", pos=(tx+0.5, ty+0.5, 0.37*S*1.8), name="tower_tlamp")
imp("speakerSmall.glb", pos=(tx-0.5, ty-0.5, 0.37*S*1.8), name="tower_speaker")
imp("rugRound.glb", pos=(tx, ty, 0.01), sc=S*2.0, name="tower_rug")
imp("coatRackStanding.glb", pos=(tx+4, ty-4, 0), name="tower_coat")
...
# Extra: bench near screen, lamp, rug, trash
imp("benchCushion.glb", pos=(crx, cry+3, 0), rot_z=math.pi, name="court_bench")
imp("lampSquareFloor.glb", pos=(crx-4.5, cry-3, 0), name="court_lamp")
imp("rugRectangle.glb", pos=(crx, cry, 0.01), sc=S*1.3, name="court_rug")
imp("trashcan.glb", pos=(crx+4.5, cry+4, 0), name="court_trash")
...
# Extra: pillows on sofas, radio, rug in kitchen, small table
...
imp("plantSmall2.glb", pos=(lx+4.5, ly+1, 0.38*S), name="lg_splant")
...
# Extra: side tables, coat rack, books, pillow on sofa
imp("sideTable.glb", pos=(-1.5, -3.5, 0), name="hub_stable1")
imp("sideTable.glb", pos=(1.5, -3.5, 0), name="hub_stable2")
imp("plantSmall1.glb", pos=(-1.5, -3.5, 0.38*S), name="hub_tplant")
imp("coatRackStanding.glb", pos=(4, -4.5, 0), name="hub_coat")
imp("pillow.glb", pos=(-2, -2.5, 0.35*S), name="hub_pillow")
imp("rugSquare.glb", pos=(0, 1, 0.01), sc=S*1.2, name="hub_deskrug")
...
out = os.path.join(PREVIEW_DIR, "step5-polish.png")
